...
% Author: Ryan Lawler
%
% Description: This model describes egress from the DAB airport.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

[top]
components : Check_In Lobby Baggage Plaza
link : out1@Lobby in1@Check_In
link : out2@Lobby in2@Baggage
link : out3@Plaza in3@Lobby
...
neighbors : Check_In(-2,-2,0) Check_In(-2,-1,0) Check_In(-2,0,0) Check_In(-2,1,0) Check_In(-2,2,0)
neighbors : Check_In(-1,-2,0) Check_In(-1,-1,0) Check_In(-1,0,0) Check_In(-1,1,0) Check_In(-1,2,0)
neighbors : Check_In(0,-2,0)  Check_In(0,-1,0)  Check_In(0,0,0)  Check_In(0,1,0)  Check_In(0,2,0)
neighbors : Check_In(1,-2,0)  Check_In(1,-1,0)  Check_In(1,0,0)  Check_In(1,1,0)  Check_In(1,2,0)
neighbors : Check_In(2,-2,0)  Check_In(2,-1,0)  Check_In(2,0,0)  Check_In(2,1,0)  Check_In(2,2,0)

%Maze plane to access dist plane. Plan to use the neighbors two cells away in order to determine direction
neighbors :                                     Check_In(-2,0,1)
neighbors :                   Check_In(-1,-1,1) Check_In(-1,0,1) Check_In(-1,1,1) 	
neighbors : Check_In(0,-2,1)  Check_In(0,-1,1)  Check_In(0,0,1)  Check_In(0,1,1)  Check_In(0,2,1)
neighbors :                   Check_In(1,-1,1)  Check_In(1,0,1)  Check_In(1,1,1)
neighbors :                                     Check_In(2,0,1)  	

% Panic Transfer
neighbors : Check_In(0,0,2)
neighbors : Check_In(0,0,-2)

% Patrol Plan Neighbors
neighbors : Check_In(-1,-1,3) Check_In(-1,0,3) Check_In(-1,1,3)
neighbors : Check_In(0,-1,3)  Check_In(0,0,3)  Check_In(0,1,3) 
neighbors : Check_In(1,-1,3)  Check_In(1,0,3)  Check_In(1,1,3)

%Alternate plane neighbors.
neighbors : Check_In(0,0,4)

%Initialize Floor Map
initialvalue : 0
initialCellsValue : Check_In.val

%Coupling between Check_In and Lobby
in : in1 
link : in1 in@Check_In(3,29,0)

%Alternate plane
zone : alternate_plane  { (0,0,4)..(9,29,4) }

%Patrol plane
zone : patrol_plane 	{ (0,0,3)..(9,29,3) }

%Panic plane
zone : panic_plane  { (0,0,2)..(9,29,2) }

%Distance plane
zone : dist_plane 	{ (0,0,1)..(9,29,1) }

%Maze plane
zone : floor_plane 	{ (0,0,0)..(9,29,0) }

localtransition : check-in-rule
...
%Get Direction
rule : 710 2000 {(0,0,0)>=701 and (0,0,0)<709 and (0,0,1)=1}
rule : 720 2000 {(0,0,0)>=701 and (0,0,0)<709 and (0,0,1)=2}
rule : 730 2000 {(0,0,0)>=701 and (0,0,0)<709 and (0,0,1)=3}
rule : 740 2000 {(0,0,0)>=701 and (0,0,0)<709 and (0,0,1)=4}
rule : 750 2000 {(0,0,0)>=701 and (0,0,0)<709 and (0,0,1)=5}
rule : 760 2000 {(0,0,0)>=701 and (0,0,0)<709 and (0,0,1)=6} 
rule : 770 2000 {(0,0,0)>=701 and (0,0,0)<709 and (0,0,1)=7}
rule : 780 2000 {(0,0,0)>=701 and (0,0,0)<709 and (0,0,1)=8} 

%Enter Cell 
rule : 701 2000 {(0,0,0)=0 and (1,0,0)=710}
rule : 702 2000 {(0,0,0)=0 and (1,-1,0)=720}
rule : 703 2000 {(0,0,0)=0 and (0,-1,0)=730}
rule : 704 2000 {(0,0,0)=0 and (-1,-1,0)=740}
rule : 705 2000 {(0,0,0)=0 and (-1,0,0)=750}
rule : 706 2000 {(0,0,0)=0 and (-1,1,0)=760}
rule : 707 2000 {(0,0,0)=0 and (0,1,0)=770}
rule : 708 2000 {(0,0,0)=0 and (1,1,0)=780}

%Leave Cell
rule : 0 2000 {((0,0,0)=710 and (-1,0,0)=0) or ((0,0,0)=710 and (-1,0,0)=900)}
rule : 0 2000 {((0,0,0)=720 and (-1,1,0)=0) or ((0,0,0)=720 and (-1,1,0)=900)}
rule : 0 2000 {((0,0,0)=730 and (0,1,0)=0) or ((0,0,0)=730 and (0,1,0)=900)}
rule : 0 2000 {((0,0,0)=740 and (1,1,0)=0) or ((0,0,0)=740 and (1,1,0)=900)}
rule : 0 2000 {((0,0,0)=750 and (1,0,0)=0) or ((0,0,0)=750 and (1,0,0)=900)}
rule : 0 2000 {((0,0,0)=760 and (1,-1,0)=0) or ((0,0,0)=760 and (1,-1,0)=900)}
rule : 0 2000 {((0,0,0)=770 and (0,-1,0)=0) or ((0,0,0)=770 and (0,-1,0)=900)}
rule : 0 2000 {((0,0,0)=780 and (-1,-1,0)=0) or ((0,0,0)=780 and (-1,-1,0)=900)}
...
%Maze plane neighbors
neighbors : Lobby(-1,-1,0) Lobby(-1,0,0) Lobby(-1,1,0)
neighbors : Lobby(0,-1,0)  Lobby(0,0,0)  Lobby(0,1,0)
neighbors : Lobby(1,-1,0)  Lobby(1,0,0)  Lobby(1,1,0)

%Maze plane to access dist plane. Plan to use the neighbors two cells away in order to determine direction
neighbors :                               Lobby(-2,0,1)
neighbors :                Lobby(-1,-1,1) Lobby(-1,0,1) Lobby(-1,1,1) 	
neighbors : Lobby(0,-2,1)  Lobby(0,-1,1)  Lobby(0,0,1)  Lobby(0,1,1)  Lobby(0,2,1)
neighbors :                Lobby(1,-1,1)  Lobby(1,0,1)  Lobby(1,1,1)
neighbors :                               Lobby(2,0,1)  	

% Panic Transfer
neighbors : Lobby(0,0,2)
neighbors : Lobby(0,0,-2)

% Patrol Plan Neighbors
neighbors : Lobby(-1,-1,3) Lobby(-1,0,3) Lobby(-1,1,3)
neighbors : Lobby(0,-1,3)  Lobby(0,0,3)  Lobby(0,1,3) 
neighbors : Lobby(1,-1,3)  Lobby(1,0,3)  Lobby(1,1,3)

%Alternate plane neighbors.
neighbors : Lobby(0,0,4)

%Initialize Floor Map
initialvalue : 0
initialCellsValue : Lobby.val

%Model Coupling
%Coupling between Check_In and Lobby
in : in3 
link : in3 in@Lobby(7,4,0)

out : out1 out2
link : out@Lobby(3,1,0) out1
link : out@Lobby(3,10,0) out2

%Alternate plane
zone : lobby_alternate_plane  { (0,0,4)..(11,11,4) }

%Patrol plane
zone : lobby_patrol_plane 	{ (0,0,3)..(11,11,3) }

%Panic plane
zone : lobby_panic_plane  { (0,0,2)..(11,11,2) }

%Distance plane
zone : lobby_dist_plane 	{ (0,0,1)..(11,11,1) }

%Maze plane
zone : lobby_floor_plane 	{ (0,0,0)..(11,11,0) }

localtransition : lobby-rule

[lobby_alternate_plane]
rule : {(0,0,0)}    1000 { t }
...
%Maze plane neighbors
neighbors : Baggage(-1,-1,0) Baggage(-1,0,0) Baggage(-1,1,0)
neighbors : Baggage(0,-1,0)  Baggage(0,0,0)  Baggage(0,1,0)
neighbors : Baggage(1,-1,0)  Baggage(1,0,0)  Baggage(1,1,0)

%Maze plane to access dist plane. Plan to use the neighbors two cells away in order to determine direction
neighbors :                                   Baggage(-2,0,1)
neighbors :                  Baggage(-1,-1,1) Baggage(-1,0,1) Baggage(-1,1,1) 	
neighbors : Baggage(0,-2,1)  Baggage(0,-1,1)  Baggage(0,0,1)  Baggage(0,1,1)  Baggage(0,2,1)
neighbors :                  Baggage(1,-1,1)  Baggage(1,0,1)  Baggage(1,1,1)
neighbors :                                   Baggage(2,0,1)  	

% Panic Transfer
neighbors : Baggage(0,0,2)
neighbors : Baggage(0,0,-2)

% Patrol Plan Neighbors
neighbors : Baggage(-1,-1,3) Baggage(-1,0,3) Baggage(-1,1,3)
neighbors : Baggage(0,-1,3)  Baggage(0,0,3)  Baggage(0,1,3) 
neighbors : Baggage(1,-1,3)  Baggage(1,0,3)  Baggage(1,1,3)

%Alternate plane neighbors.
neighbors : Baggage(0,0,4)

%Initialize Floor Map
initialvalue : 0
initialCellsValue : Baggage.val

%Coupling between Check_In and Lobby
in : in2
link : in2 in@Baggage(3,0,0)

%Alternate plane
zone : baggage_alternate_plane  { (0,0,4)..(18,28,4) }

%Patrol plane
zone : baggage_patrol_plane 	{ (0,0,3)..(18,28,3) }

%Panic plane
zone : baggage_panic_plane  { (0,0,2)..(18,28,2) }


%Distance plane
zone : baggage_dist_plane 	{ (0,0,1)..(18,28,1) }

%Maze plane
zone : baggage_floor_plane 	{ (0,0,0)..(18,28,0) }

localtransition : baggage-rule

[baggage_alternate_plane]
rule : {(0,0,0)}    1000 { t }

[baggage_patrol_plane]
rule : {(0,0,0)}    1000 { t }
...
%Maze plane neighbors
neighbors : Plaza(-1,-1,0) Plaza(-1,0,0) Plaza(-1,1,0)
neighbors : Plaza(0,-1,0)  Plaza(0,0,0)  Plaza(0,1,0)
neighbors : Plaza(1,-1,0)  Plaza(1,0,0)  Plaza(1,1,0)

%Maze plane to access dist plane. Plan to use the neighbors two cells away in order to determine direction
neighbors :                               Plaza(-2,0,1)
neighbors :                Plaza(-1,-1,1) Plaza(-1,0,1) Plaza(-1,1,1) 	
neighbors : Plaza(0,-2,1)  Plaza(0,-1,1)  Plaza(0,0,1)  Plaza(0,1,1)  Plaza(0,2,1)
neighbors :                Plaza(1,-1,1)  Plaza(1,0,1)  Plaza(1,1,1)
neighbors :                               Plaza(2,0,1)  	

% Panic Transfer
neighbors : Plaza(0,0,2)
neighbors : Plaza(0,0,-2)

% Patrol Plan Neighbors
neighbors : Plaza(-1,-1,3) Plaza(-1,0,3) Plaza(-1,1,3)
neighbors : Plaza(0,-1,3)  Plaza(0,0,3)  Plaza(0,1,3) 
neighbors : Plaza(1,-1,3)  Plaza(1,0,3)  Plaza(1,1,3)

%Alternate plane neighbors.
neighbors : Plaza(0,0,4)

%Initialize Floor Map
initialvalue : 0
initialCellsValue : Plaza.val

%Model Coupling
out : out3
link : out@Plaza(6,9,0) out3


%Alternate plane
zone : plaza_alternate_plane  { (0,0,4)..(18,21,4) }

%Patrol plane
zone : plaza_patrol_plane 	{ (0,0,3)..(18,21,3) }

%Panic plane
zone : plaza_panic_plane  { (0,0,2)..(18,21,2) }

%Distance plane
zone : plaza_dist_plane 	{ (0,0,1)..(18,21,1) }

%Maze plane
zone : plaza_floor_plane 	{ (0,0,0)..(18,21,0) }

localtransition : plaza-rule

[plaza_alternate_plane]
rule : {(0,0,0)}    1000 { t }
